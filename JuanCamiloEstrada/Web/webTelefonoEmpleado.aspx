<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="webTelefonoEmpleado.aspx.cs" Inherits="WEB.webInmoviliaria.webTelefonoCliente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        ...
        <table style="width: 71%">
            ...
            <tr>
                <td class="text-left" style="font-size: large"><strong>CORREO:</strong></td>
                <td class="text-left">
                    <asp:Label ID="lblCorreo" runat="server" style="font-size: large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="text-left" style="font-size: large"><strong>TIPO DE TELÉFONO:</strong></td>
                <td>
                    <asp:DropDownList ID="cboTelefono" runat="server" style="font-size: large" Height="22px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
